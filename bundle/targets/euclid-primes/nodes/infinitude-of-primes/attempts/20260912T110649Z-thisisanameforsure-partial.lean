...
`sorry` replaced, header included. The factorial is Mathlib's `Nat.factorial`, reached through
that import: the target's own `Opn.fact` (Defs.Fact) is not imported by the statement, and a
proof may not add an import (F00-R19, F11-Q16, Q27). -/
